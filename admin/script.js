...
class AdminApp {
    ...
    setupEventListeners() {
        ...
        // Delete all orders
        document.getElementById('deleteAllOrders').addEventListener('click', () => {
        ...
        document.getElementById('menuItemModal').addEventListener('hidden.bs.modal', () => {
            this.resetMenuItemForm();
        });

        document.getElementById('quickActionModal').addEventListener('hidden.bs.modal', () => {
